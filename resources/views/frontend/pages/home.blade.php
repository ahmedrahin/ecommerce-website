...
<html lang="en">
  ...
  <body class="skeleton_body">
      ...
      <header> 
        ...
        <div class="custom-container container header-1">
          <div class="row"> 
            ...
            <div class="col-12">
              <div class="main-menu"> <a class="brand-logo" href="#"> <img class="img-fluid for-light" src="../assets/images/logo/logo.png" alt="logo"/><img class="img-fluid for-dark" src="../assets/images/logo/logo-white-1.png" alt="logo"/></a>
                <nav id="main-nav-1">
                  <ul class="nav-menu sm-horizontal">
                    ...
                    <li> <a class="nav-link" href="#">FashiOffers 
                        <p class="lable-nav">Hot</p></a></li>
                ...
                <div class="sub_header">
                  ...
                  <ul class="justify-content-end">
                    <li> 
                      <button><i class="iconsax" data-icon="search-normal-2"></i></button>
                    </li>
    ...
    <header> 
      <div class="top_header"> 
        <p>Free Coupne Code: Summer Sale On Selected items Use:<span>NEW 26</span><a href="collection-left-sidebar.html"> SHOP NOW</a></p>
      </div>
      <div class="custom-container container header-1">
        <div class="row"> 
          <div class="col-12 p-0"> 
          ...
          <div class="col-12">
            <div class="main-menu"> <a class="brand-logo" href="index.html"> <img class="img-fluid for-light" src="../assets/images/logo/logo.png" alt="logo"/><img class="img-fluid for-dark" src="../assets/images/logo/logo-white-1.png" alt="logo"/></a>
              <nav id="main-nav">
                <ul class="nav-menu sm-horizontal theme-scrollbar" id="sm-horizontal">
                  ...
                  <li> <a class="nav-link" href="#">Home <span> <i class="fa-solid fa-angle-down"></i></span></a>
                    <div class="mega-menu">
                      <div class="row gy-3"> 
                        <div class="col-xl-3"><a class="layout-images" href="index.html" target="_blank">
                            <div class="layout-box img-1"> </div>
                            <h5>Layout 1</h5></a></div>
                        <div class="col-xl-3"> <a class="layout-images" href="layout-2.html" target="_blank">
                            <div class="layout-box img-2"></div>
                            <h5>Layout 2</h5></a></div>
                        <div class="col-xl-3"><a class="layout-images" href="layout-3.html" target="_blank">
                            <div class="layout-box img-3"></div>
                            <h5>Layout 3</h5></a></div>
                        <div class="col-xl-3"> <a class="layout-images" href="layout-4.html" target="_blank">
                            <div class="layout-box img-4"></div>
                            <h5>Layout 4</h5></a></div>
                      </div>
                    </div>
                  </li>
                  <li> <a class="nav-link" href="#">Shop<span> <i class="fa-solid fa-angle-down"></i></span></a>
                    <ul class="nav-submenu">
                      ...
                      <li> <a href="collection-list-view.html">Collection List View <span class="badge-sm theme-default">new</span></a></li>
                      ...
                      <div class="row">
                        <div class="col-xl-4">
                          <ul class="p-2"> 
                            ...
                            <li> <a href="product-video.html">Product Video<span class="badge-sm theme-default">new</span></a></li>
                            <li> <a href="product-accordion.html">Product Accordion</a></li>
                            <li> <a href="product-sold-out.html">Product Sold Out <span class="badge-sm danger-color animated">Hot</span></a></li>
                            <li> <a href="without-thumbnail.html">Without Thumbnail </a></li>
                          </ul>
                        </div>
                        <div class="col-xl-4">
                          <ul class="p-2">
                            <li> <a href="product-bundle.html">Bundle (Cross Sale) <span class="badge-sm danger-color animated">Hot</span></a></li>
                            <li> <a href="variant-rectangle.html">Variant Rectangle  </a></li>
                            <li> <a href="variant-images.html"> Variant Image Swatch <span class="badge-sm theme-default">new</span></a></li>
                            ...
                            <li> <a href="inner-zoom.html">Inner Zoom Images <span class="badge-sm danger-color animated">Hot</span></a></li>
                          </ul>
                        </div>
                        <div class="col-xl-4 d-none d-xl-block px-0">
                          <div class="menu-banner">   <img class="w-100 img-fluid" src="../assets/images/mega-menu/banner.png" alt=""/></div>
                        </div>
                      </div>
                    </div>
                  </li>
                  <li> <a class="nav-link" href="#">FashiOffers <span> <i class="fa-solid fa-angle-down"></i></span>
                      <p class="lable-nav">Hot</p></a>
                    <div class="mega-menu p-0 overflow-hidden">
                      <div class="row gy-4 align-items-center">
                        <div class="col-xl-5">
                          <div class="mega-img">
                            <div class="img-1"><img class="img-fluid" src="../assets/images/mega-menu/5.jpg" alt=""/></div>
                            <div class="img-1"><img class="img-fluid" src="../assets/images/mega-menu/6.jpg" alt=""/></div>
                          </div>
                        </div>
                        <div class="col-xl-2 px-0">
                          <ul>
                            <li> <a href="../email-template/welcome.html">Welcome Template<span class="badge-sm danger-color animated">Hot</span></a></li>
                            <li> <a href="../email-template/order-success.html">Order Success</a></li>
                            <li> <a href="../email-template/reset-password.html">Reset Password</a></li>
                        ...
                        <div class="col-xl-5"><img class="img-fluid" src="../assets/images/mega-menu/1.png" alt=""/></div>
                      </div>
                    </div>
                  </li>
                  <li> <a class="nav-link" href="#">Page  <span> <i class="fa-solid fa-angle-down"></i></span></a>
                    <ul class="nav-submenu">
                      ...
                      <li> <a href="maintenance.html">Maintenance<span class="badge-sm danger-color animated">Hot</span></a></li>
                      ...
                      <li> <a href="login.html"> Login <span class="badge-sm danger-color animated">Hot </span></a></li>
                      <li> <a href="forget-password.html"> Forgot Password </a></li>
                      <li> <a href="otp.html"> otp </a></li>
                      <li> <a href="sign-up.html"> Sign Up </a></li>
                    </ul>
                  </li>
                  <li> <a class="nav-link" href="#">Blog<span> <i class="fa-solid fa-angle-down"></i></span></a>
                    <ul class="nav-submenu">
    ...
    <section class="pt-0 home-section-3">
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col pe-0">  
            <div class="home-banner p-right">                            <img class="img-fluid" src="../assets/images/layout-3/1.jpg" alt=""/>
              <div class="contain-banner"> 
                <div> 
    ...
    <section class="section-t-space">
      <div class="custom-container container service">
        <ul>
          <li>
            <div class="service-block"><img src="../assets/images/svg-icon/1.svg" alt=""/>
              <div>    
          ...
          <li>
            <div class="service-block"><img src="../assets/images/svg-icon/2.svg" alt=""/>
              <div>    
          ...
          <li>
            <div class="service-block border-0"><img src="../assets/images/svg-icon/4.svg" alt=""/>
              <div>    
      ...
      <div class="custom-container container">
        <div class="row"> 
          <div class="col-xxl-5 col-lg-8 offer-box-1">
            <div class="row gy-4 ratio_45">
              <div class="col-12">
                <div class="collection-banner p-left">                                <img class="bg-img" src="../assets/images/banner/banner-7.jpg" alt=""/>
                  <div class="contain-banner"> 
                    <div> 
                      <h4>Up to 60% OFF</h4>
              ...
              <div class="col-12">
                <div class="collection-banner p-right"><img class="bg-img" src="../assets/images/banner/banner-8.jpg" alt=""/>
                  <div class="contain-banner"> 
                    <div> 
                      <h4>Up to 60% OFF</h4>
          ...
          <div class="col-4 d-none d-xxl-block"> 
            <div class="offer-banner-3 ratio1_3"> <a href="#"> <img class="bg-img" src="../assets/images/banner/banner-9.jpg" alt=""/>
          ...
          <div class="row"> 
            <div class="col-xl-3 col-lg-4 col-md-6">
              <div class="footer-content">
                <div class="footer-logo"><a href="index.html"> <img class="img-fluid" src="../assets/images/logo/logo-white-1.png" alt="Footer Logo"/></a></div>
                <ul> 
              ...
              <div class="col-lg-6 rtl-text">
                <div class="product-right">
                  ...
                  <div class="border-product">
                    ...
                    <p>Western yoke on an Indigo shirt made of 100% cotton. Ideal for informal gatherings, this top will ensure your comfort and style throughout the day.</p>
                  </div>
                  ...
                  <div class="product-buttons"><a class="btn btn-solid" href="cart.html">Add to cart</a><a class="btn btn-solid" href="product.html">View detail</a></div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                <div class="col-12 px-0">  
                  <div class="modal-bg addtocart">
                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                    <div class="d-flex"><a href="#"><img class="img-fluid blur-up lazyload pro-img" src="../assets/images/modal/0.jpg" alt=""/></a>
                      <div class="add-card-content align-self-center text-center"><a href="#">
                          <h6><i class="fa-solid fa-check">  </i>Item <span>men full sleeves</span><span> successfully added to your Cart</span></h6></a>
                        <div class="buttons"><a class="view-cart btn btn-solid" href="cart.html">Your cart</a><a class="checkout btn btn-solid" href="check-out.html">Check out</a><a class="continue btn btn-solid" href="index.html">Continue shopping</a></div>
                        <div class="upsell_payment"><img class="img-fluid blur-up lazyload" src="../assets/images/payment_cart.png" alt=""/></div>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="offcanvas offcanvas-end shopping-details" id="offcanvasRight" tabindex="-1" aria-labelledby="offcanvasRightLabel">
        ...
        <ul class="offcanvas-cart">
          <li> <a href="#"> <img src="../assets/images/cart/1.jpg" alt=""/></a>
            <div> 
              ...
              <p>$35
                <del>$40</del><span class="btn-cart">$<span class="btn-cart__total" id="total">105</span></span>
              </p>
          ...
          <li> <a href="#"> <img src="../assets/images/cart/2.jpg" alt=""/></a>
            <div> 
              <h6 class="mb-0">Shirts Men's Clothing</h6>
              <p>$35
                <del>$40</del><span class="btn-cart">$<span class="btn-cart__total" id="total1">105</span></span>
              </p>
              <div class="btn-containter">
                <div class="btn-control">
          ...
          <li> <a href="#"> <img src="../assets/images/cart/3.jpg" alt=""/></a>
            <div> 
              <h6 class="mb-0">Shirts Men's Clothing</h6>
              <p>$35
                <del>$40</del><span class="btn-cart">$<span class="btn-cart__total" id="total2">105</span></span>
              </p>
              <div class="btn-containter">
                <div class="btn-control">
          ...
          <li> <a href="#"> <img src="../assets/images/cart/4.jpg" alt=""/></a>
            <div> 
              <h6 class="mb-0">Shirts Men's Clothing</h6>
              <p>$35
                <del>$40</del><span class="btn-cart">$<span class="btn-cart__total" id="total3">105</span></span>
              </p>
              <div class="btn-containter">
                <div class="btn-control">
      ...
      <div class="offcanvas-footer">
        ...
        <div class="cart-button"> <a class="btn btn_outline" href="cart.html"> View Cart</a><a class="btn btn_black" href="check-out.html"> Checkout</a></div>
      </div>
    </div>
      ...
      <div class="offcanvas-body theme-scrollbar">
        <div class="container">
          ...
          <div class="search-box"> 
            <input type="search" name="text" placeholder="I'm looking for…"/><i class="iconsax" data-icon="search-normal-2"></i>
          </div>
          <h4>Popular Searches</h4>
          <ul class="rapid-search">
            <li> <a href="collection-left-sidebar.html"><i class="iconsax" data-icon="search-normal-2"></i>Jeans Women</a></li>
            <li> <a href="collection-left-sidebar.html"><i class="iconsax" data-icon="search-normal-2"></i>Blazer Women</a></li>
            <li> <a href="collection-left-sidebar.html"><i class="iconsax" data-icon="search-normal-2"></i>Jeans Men</a></li>
            <li> <a href="collection-left-sidebar.html"><i class="iconsax" data-icon="search-normal-2"></i>Blazer Men</a></li>
            <li> <a href="collection-left-sidebar.html"><i class="iconsax" data-icon="search-normal-2"></i>T-Shirts Men</a></li>
            <li> <a href="collection-left-sidebar.html"><i class="iconsax" data-icon="search-normal-2"></i>Shoes Men</a></li>
            <li> <a href="collection-left-sidebar.html"><i class="iconsax" data-icon="search-normal-2"></i>T-Shirts Women</a></li>
            <li> <a href="collection-left-sidebar.html"><i class="iconsax" data-icon="search-normal-2"></i>Bags</a></li>
            <li> <a href="collection-left-sidebar.html"><i class="iconsax" data-icon="search-normal-2"></i>Sneakers Women</a></li>
            <li> <a href="collection-left-sidebar.html"><i class="iconsax" data-icon="search-normal-2"></i>Dresses</a></li>
          </ul>
          ...
          <div class="row gy-4 ratio_square-2 preemptive-search"> 
            <div class="col-xl-2 col-sm-4 col-6"> 
              <div class="product-box-6">
                <div class="img-wrapper">
                  <div class="product-image"><a href="product.html"> <img class="bg-img" src="../assets/images/product/product-2/blazers/1.jpg" alt="product"/></a></div>
                </div>
                <div class="product-detail">
                  <div><a href="product.html"> 
                      <h6> Women's Stylish Top</h6></a>
                    <p>$50.00 </p>
                    <ul class="rating">      
                      <li><i class="fa-solid fa-star"></i></li>
                      <li><i class="fa-solid fa-star"></i></li>
            ...
            <div class="col-xl-2 col-sm-4 col-6"> 
              <div class="product-box-6">
                <div class="img-wrapper">
                  <div class="product-image"><a href="product.html"> <img class="bg-img" src="../assets/images/product/product-2/blazers/2.jpg" alt="product"/></a></div>
                </div>
                <div class="product-detail">
                  <div><a href="product.html"> 
                      <h6> Women's Stylish Top</h6></a>
            ...
            <div class="col-xl-2 col-sm-4 col-6"> 
              <div class="product-box-6">
                <div class="img-wrapper">
                  <div class="product-image"><a href="product.html"> <img class="bg-img" src="../assets/images/product/product-2/blazers/3.jpg" alt="product"/></a></div>
                </div>
                <div class="product-detail">
                  <div><a href="product.html"> 
                      <h6> Women's Stylish Top</h6></a>
            ...
            <div class="col-xl-2 col-sm-4 col-6"> 
              <div class="product-box-6">
                <div class="img-wrapper">
                  <div class="product-image"><a href="product.html"> <img class="bg-img" src="../assets/images/product/product-2/blazers/4.jpg" alt="product"/></a></div>
                </div>
                <div class="product-detail">
                  <div><a href="product.html"> 
                      <h6> Women's Stylish Top</h6></a>
            ...
            <div class="col-xl-2 col-sm-4 col-6"> 
              <div class="product-box-6">
                <div class="img-wrapper">
                  <div class="product-image"><a href="product.html"> <img class="bg-img" src="../assets/images/product/product-2/blazers/5.jpg" alt="product"/></a></div>
                </div>
                <div class="product-detail">
                  <div><a href="product.html"> 
                      <h6> Women's Stylish Top</h6></a>
            ...
            <div class="col-xl-2 col-sm-4 col-6"> 
              <div class="product-box-6">
                <div class="img-wrapper">
                  <div class="product-image"><a href="product.html"> <img class="bg-img" src="../assets/images/product/product-2/blazers/6.jpg" alt="product"/></a></div>
                </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body p-0">
            <div class="news-latter-box">
              <div class="row align-items-center"> 
                <div class="col-lg-6">
                  <div class="newslwtter-content"><img class="img-fluid" src="../assets/images/other-img/text.png" alt=""/>
                ...
                <div class="col-md-6 d-none d-lg-block"> 
                  <div class="newslwtter-img"> <img class="img-fluid" src="../assets/images/other-img/news-latter.png" alt=""/></div>
                </div>
              </div>
            </div>
          </div>
