            ...
            <div class="accordion" id="accordionPanelsStayOpenExample">
              ...
              <div class="accordion-item">
                <h2 class="accordion-header">
                  <button class="accordion-button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseEight"><span>Collections</span></button>
                </h2>
                <div class="accordion-collapse collapse show" id="panelsStayOpen-collapseEight">
                  <div class="accordion-body">
                    <ul class="collection-list">
                      ...
                      <li> 
                        <input class="custom-checkbox" id="category12" type="checkbox" name="text">
                        <label for="category12">New arrivals</label>
                      </li>
                      <li> 
                        <input class="custom-checkbox" id="category13" type="checkbox" name="text">
                ...
                <div class="accordion-collapse collapse show" id="panelsStayOpen-collapseTwo">
                  <div class="accordion-body">
                    <ul class="catagories-side theme-scrollbar">
                      ...
                      <li> 
                        <input class="custom-checkbox" id="category3" type="checkbox" name="text">
                        <label for="category3">Women’s Shirts</label>
                      </li>
                      <li> 
                        <input class="custom-checkbox" id="category4" type="checkbox" name="text">
                        <label for="category4">Top T-shirt</label>
                      </li>
                      <li> 
                        <input class="custom-checkbox" id="category5" type="checkbox" name="text">
                        <label for="category5">Denim (8)</label>
                      </li>
                      <li> 
                        <input class="custom-checkbox" id="category6" type="checkbox" name="text">
                        <label for="category6">Grains & Beans (8)</label>
                      </li>
                      <li> 
                        <input class="custom-checkbox" id="category7" type="checkbox" name="text">
                        <label for="category7">Cosmopolis</label>
                      </li>
                      <li> 
                        <input class="custom-checkbox" id="category8" type="checkbox" name="text">
              ...
              <div class="accordion-item">
                <h2 class="accordion-header">
                  <button class="accordion-button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseSix"><span>Availability</span></button>
                </h2>
        ...
        <div class="col-xl-9">
          <div class="sticky">
            ...
            <div class="product-tab-content ratio1_3">
                ...
                <livewire:frontend.product.shop-product></livewire>
