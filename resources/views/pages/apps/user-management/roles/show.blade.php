<x-default-layout>
    ...
    @section('breadcrumbs')
    {{ Breadcrumbs::render('admin-management.roles.show', $role) }}
    @endsection
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="d-flex flex-column text-gray-600">
                            ...
                            @else 
                                @foreach($role->permissions->sortBy('id')->shuffle() ?? [] as $permission)
                                    <div class="d-flex align-items-center py-2">
                                ...
                                @endif
                            @endif
                            {{-- <livewire:permission.role-to-permission></livewire:permission.role-to-permission> --}}
                        </div>
                        <!--end::Permissions-->
                    </div>
                    <!--end::Card body-->
                    ...
                    {{-- <div class="card-footer pt-0">
                        <button type="button" class="btn btn-light btn-active-primary" data-role-name="{{ $role->name }}"
                            data-bs-toggle="modal" data-bs-target="#kt_modal_update_role" data-kt-action="update_row">Edit Role</button>
                    </div> --}}
                    <!--end::Card footer-->
                </div>
                <!--end::Card-->
