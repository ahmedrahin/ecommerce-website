...
class CategoriesDataTable extends DataTable
{
    ...
    public function query(Category $model): QueryBuilder
    {
        ...
        $categories = Cache::rememberForever($cacheKey, function () use ($model) {
            return $model->newQuery()->with('subcategories.subsubcategories')->orderByDesc('id')->get(); // Include relationships
        });

        return $model->newQuery()->whereIn('id', $categories->pluck('id'));
    }
